...
| stats count(\*) as Total\_Count by sourceIPAddress as Source\_IP, errorMessage as Reason, awsRegion as AWS\_Region, userIdentity.arn as IAM\_Arn
...
!\[Consulta ingresada](imagenes/t5-consulta-ingresada.png)

!\[Ejecutar consulta](imagenes/t5-ejecutar-consulta.png)
...
\- \*\*Source\_IP\*\*: Dirección IP desde donde se intentó acceder

\- \*\*Reason\*\*: Motivo del fallo ("Failed authentication")

\- \*\*AWS\_Region\*\*: Región donde ocurrió el intento

\- \*\*IAM\_Arn\*\*: ARN del usuario que intentó acceder

\- \*\*Total\_Count\*\*: Número de intentos fallidos por combinación de factores



!\[Resultados de la consulta](imagenes/t5-resultados.png)
